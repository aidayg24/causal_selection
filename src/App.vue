<template>
  <Experiment title="Experiment">
    ...
    <InstructionScreen :title="'Instructions'">
      <p>
        In this "Icon Card Game", there are <strong>two players</strong>.
        ...
        in their deck. The players do not know what is on the other side of the cards.
      </p>
    ...
    <InstructionScreen :title="'Instructions'">
      <p>
        Each card is worth one point, and the explanation under each icon shows which
        player gets the point if that type of card is drawn.
      </p>
    ...
    <InstructionScreen :title="'Instructions'">
      <p>After the game, Yoda, <strong><em>who knows the exact number of each icon in every deck,</em></strong> 
